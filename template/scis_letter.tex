...
\DOI{xxxxxxxxxxxxxx}
\ArtNo{xxxxxx}
\ReceiveDate{January 1, 2016}
\AcceptDate{January 1, 2016}
...
\address[1]{Address, City {\rm 000000}, Country}
\address[2]{Address, City {\rm 000000}, Country}
\address[3]{Address, City {\rm 000000}, Country}
...
\bibitem{2} Author A, Author B, Author C. Reference title. Conference, Place, Year. Number or pages
...
%%% Other. 其他格式
\th{Title} %emphasized phrase. 着重强调短语
\proof %proof. 证明
